...
if __name__ == '__main__':
    ...
    # 图片和标签文件存储夹
    src_path_imgs = "/media/dell/sata4t/jwang/datasets/items_datasets/danger_drive/dd20230831/image"
    src_path_labels = "/media/dell/sata4t/jwang/datasets/items_datasets/danger_drive/dd20230831/label"

    # 图片和标签文件分帧保存文件夹
    dest_path_img = "/media/dell/sata4t/jwang/datasets/items_datasets/danger_drive/dd20230831/"
    dest_path_label = "/media/dell/sata4t/jwang/datasets/items_datasets/danger_drive/dd20230831/"
